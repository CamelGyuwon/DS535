...
def evaluate(data_loader, data_te, mask_his, topN):
    ...
    with torch.no_grad():
        for batch_idx, batch in enumerate(data_loader):
            ...
            prediction_list = diffusion.p_sample_langevin_gibbs(model, batch_latent, args.sampling_steps, time_classifier, args.sampling_noise, args.exploration_size, args.exploration_length, args.exploration_number)
